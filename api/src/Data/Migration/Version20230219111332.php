 ...
 */
final class Version20230219111332 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE subscribers ALTER created DROP DEFAULT');
        $this->addSql('ALTER TABLE subscribers ALTER created SET NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE subscribers ALTER created SET DEFAULT CURRENT_TIMESTAMP');
        $this->addSql('ALTER TABLE subscribers ALTER created DROP NOT NULL');
    }
}
